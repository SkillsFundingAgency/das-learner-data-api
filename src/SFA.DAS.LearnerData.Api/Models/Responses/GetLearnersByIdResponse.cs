...
public record GetLearnersByIdResponseItem : LearnerResponse
{
    ...
    public static List<GetLearnersByIdResponseItem> MapFrom(IEnumerable<GetLearnersByIdResultItem> results)
    {
        return results.Select(result => new GetLearnersByIdResponseItem
        {
            Id = result.Id,
